...
export const NavBar = ({ status, setStatus }) => {
    ...
    const menuArr = ['여성', 'Divided', '남성',
        '신생아/유아', '아동',
        'H&M Home', 'Sale', '지속 가능성']
    // 메뉴의 열림/닫힘 상태 관리
    ...
    return (
        <div>
            ...
            <div className='menuBar'>
                ...
                <ul className={`menuList ${isMobile && isMenuOpen ? 'open' : ''}`} onClick={handleMenuClick}>
                ...
                <div className='searchBox'>
                    ...
                    <input id='inputTxt' style={{ marginLeft: '5px' }} onKeyUp={(e) => search(e)} type='text' />
                </div>
            </div>
        </div>
    )
